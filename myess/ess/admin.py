...
class ControlTASK(admin.ModelAdmin):
    list_display = ('uname','pname','waibao','task_id','dtime','kinds','pnums','knums','ptimes')
    ordering = ("-dtime",)
...
class ControlWaibao(admin.ModelAdmin):
    list_display = ('pname','get_data_time','pnums','knums','settlement_method','unit_price','wb_name')
